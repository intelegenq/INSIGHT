  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const dex = (pRes.projects || []).filter((p: Project) => p.category === "dex");
        setProjects(
    ...
    <div className="main-content">
      <div style={{ maxWidth: "none", margin: 0, padding: "32px 24px" }}>
        ...
        <p style={{ fontSize: 13, color: "var(--text-muted)", marginBottom: 32 }}>
          Solana decentralized exchanges — volume, TVL, and rankings.
        </p>
        {loading ? (
          ...
          <>
            ...
            {dexVol && dexVol.protocols.length > 0 && (
              <div style={{ marginBottom: 48 }}>
                <div style={headerStyle}>Volume by Protocol (24h)</div>
                <InsightChart
