...
export type RuntimeEvent =
  ...
  | { type: "execution.completed"; executionId: string; jobId: string; timestamp: string; durationMs: number }
  | { type: "execution.failed"; executionId: string; jobId: string; timestamp: string; durationMs: number; errorCode: ErrorCode };
